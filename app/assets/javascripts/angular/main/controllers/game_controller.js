...
MyApp.controller("GameController", ["$scope", "$timeout" , "$interval" , "CONST" , "Auth" , "CustomActionService" , "GamesFactory", "GameFactory", "userService", "$location",
 function($scope, $timeout , $interval , CONST , Auth , CustomActionService , GamesFactory, GameFactory, userService, $location){
